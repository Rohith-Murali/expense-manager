...
const Sidebar = () => {
    ...
    return (
        <aside
            className={`fixed left-0 top-0 h-full gradient-sidebar text-white transition-all duration-300 z-40 ${sidebarCollapsed ? 'w-20' : 'w-64'
                }`}
        >
            {/* Logo Section */}
                    ...
                    {menuItems.map((item) => (
                        <li key={item.path}>
                            <NavLink
                                ...
                                className={({ isActive }) =>
                                    `sidebar-item ${isActive ? 'sidebar-item-active' : ''} ${sidebarCollapsed ? 'justify-center px-0' : ''
                                    }`
                                }
