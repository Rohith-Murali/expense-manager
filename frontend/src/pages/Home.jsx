      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="card mb-8 fade-in">
          ...
          <p className="text-gray-600">
            Start managing your expenses efficiently. Track your income, expenses, and transfers all in one place.
          </p>
        </div>
        ...
        {/* Recent Transactions */}
        <div className="card mt-8 fade-in" style={{ animationDelay: '0.4s' }}>
          <div className="flex items-center justify-between mb-4">
